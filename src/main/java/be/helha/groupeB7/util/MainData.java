...
public class MainData {
	...
	public static void main(String[] args) {
		...
		Evenement event0 = new Evenement("Pluie","Soignies","PluiEDESCRIPTION",new Date(),new Date(), Tools.readFile("C:\\\\Users\\\\Kista\\\\Pictures\\\\image3.jpg"), true,0);
		Evenement event1 = new Evenement("Soleil","Soignies","Descritiondusoleilàsoignies",new Date(),new Date(), Tools.readFile("C:\\\\Users\\\\Kista\\\\Pictures\\\\image2.jpg"), true,0);
		Evenement event2 = new Evenement("Lune","Mars","Descriptionmarsàlune",new Date(),new Date(), Tools.readFile("C:\\\\Users\\\\Kista\\\\Pictures\\\\image.jpg"), true,0);
