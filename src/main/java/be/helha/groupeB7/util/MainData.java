...
public class MainData {
	...
	public static void main(String[] args) {
		...
		Evenement event1 = new Evenement("Soleil","Soignies","Descritiondusoleilàsoignies",new Date(),new Date(), Tools.readFile("C:\\\\Users\\\\simon\\\\OneDrive\\\\Pictures\\\\Trash\\\\image2.jpg"), true, 0);
		Evenement event2 = new Evenement("Lune","Mars","Descriptionmarsàlune",new Date(),new Date(), Tools.readFile("C:\\\\Users\\\\simon\\\\OneDrive\\\\Pictures\\\\Trash\\\\image2.jpg"), true, 0);
